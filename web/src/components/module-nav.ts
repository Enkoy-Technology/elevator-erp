 ...
 *  SUPER_ROLES. Keep the two lists identical: a role missing here sees a
 *  sidebar narrower than what the API would actually answer. */
...
export const MODULES: ModuleNavItem[] = [
  ...
  },
  {
    ...
    group: 'sales',
    description: 'Quotes; approval issues the proforma',
    phase: null,
    href: '/quotations',
  ...
  },
  {
    ...
    group: 'finance',
    description: 'Send greetings & notices; delivery log',
    phase: null,
    href: '/messages',
